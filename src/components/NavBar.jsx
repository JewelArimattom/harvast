  ...
  return (
    <div className='bg-white flex items-center justify-between py-5 font-medium'>
      ...
      <h2 className='text-2xl font-bold text-black md:text-3xl cursor-pointer'>
        ...
        <font>R</font>
        <font>V</font>
        <font className='text-red-600 lg:text-5xl '>A</font>
        <font>S</font>
        <font>T</font>
      </h2>
      ...
      <div className='flex items-center gap-6'>
        ...
        <div className='group relative'>
         <img onClick={() => token ? null : navigate('/login')} src="https://cdn-icons-png.flaticon.com/512/3135/3135715.png" className='w-5 cursor-pointer ' alt=""  /> 
          {/*down menu */}
          {token && <div className='absolute pt-4 right-0 bg-white hidden group-hover:block dropdown-menu '>
            <div className='flex flex-col gap-2 w-36 py-3 px-5 bg-white text-gray-700 rounded'>
              <p className='cursor-pointer hover:text-black'>My Profile</p>
              <p onClick={() => navigate('/orders')} className='cursor-pointer hover:text-black'>Orders</p>
              <p onClick={handleLogout} className='cursor-pointer hover:text-black'>Logo Out</p>
