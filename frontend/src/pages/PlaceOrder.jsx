      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row'>
            <div onClick={()=>setMethod("stripe")} className='flex items-center gap-3 border border-black rounded-md p-2 cursor-pointer'>
            ...
            <div onClick={()=>setMethod("razorpay")} className='flex items-center gap-3 border border-black rounded-md p-2 cursor-pointer'>
